      ...
      const form = `
          <form id="edit-task-form">
              ...
              <select name="priority">
                  <option value="Important_et_urgent" ${priority === 'Important_et_urgent' ? 'selected' : ''}>Important et urgent</option>
                  <option value="Urgent_mais_non_important" ${priority === 'Urgent_mais_non_important' ? 'selected' : ''}>Urgent mais non important</option>
                  <option value="Important_mais_non_urgent" ${priority === 'Important_mais_non_urgent' ? 'selected' : ''}>Important mais non urgent</option>
                  <option value="Non_urgent_et_non_important" ${priority === 'Non_urgent_et_non_important' ? 'selected' : ''}>Non urgent et non important</option>
              </select>
